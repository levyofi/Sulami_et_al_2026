...
save(df_p_solar, file = "code/Figures/predicted_solar.RData")
...
save(df_p_TGI, file = "code/Figures/predicted_TGI.RData")
...
save(df_p_skyview, file = "code/Figures/predicted_skyview.RData")
...
save(df_p_slope, file = "code/Figures/predicted_solar_sd.RData")
