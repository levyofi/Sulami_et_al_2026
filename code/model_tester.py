...
maps_folder = "/data/idan/complete_subimages_cropped"
...
# Get the best model fot this spatial size
...
# Calculate the errors - will calcculate any missing predicted and true maps
